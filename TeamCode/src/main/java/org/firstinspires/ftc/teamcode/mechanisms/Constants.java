...
// ===========  for arm movements ======================
    ...
    public  static final int ARM_DEPOSIT_LONG = 160;// was 170 feb2, now
    ...
    public static final double WRIST_DEPOSIT_MID = .6;
    public  static final double WRIST_DEPOSIT_LONG = .4;// was 1
