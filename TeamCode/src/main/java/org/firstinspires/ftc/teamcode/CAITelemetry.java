...
public class CAITelemetry implements Telemetry {
    private static final boolean DASHBOARD_ENABLED = true;
    private static final boolean TELEMETRY_ENABLED = true;
    Telemetry dashboardTelemetry;
    Telemetry ftcTelemetry;
    FtcDashboard dashboard;
    private boolean dashboardEnabled = DASHBOARD_ENABLED;
    private boolean telemetryEnabled = TELEMETRY_ENABLED;
